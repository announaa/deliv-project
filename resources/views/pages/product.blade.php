				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<h2 class="product-name">{{$proname}}</h2>
							...
							<div>
								<h3 class="product-price"><span class="c_lbp" style="display:none;">LBP{{$product->Product_Unit_Price *1500}}</span><span class="c_usd">${{$product->Product_Unit_Price}}</span> <!--<del class="product-old-price">$990.00</del>--></h3>
								@if ($product->Product_Availability_Status == 'Y')	
